...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // cart_item
    Route::get('/v1/cart_item/index_cart_item', [Cart_itemController::class, 'index_cart_item']);
    Route::post('/v1/cart_item/store_cart_item', [Cart_itemController::class, 'store_cart_item']);
